...
//PCI Express
  ...
  wire[C_NF_DATA_WIDTH-1:0]      axis_i_2_tdata , axis_o_2_tdata;
  wire                        axis_i_2_tvalid, axis_o_2_tvalid;
  wire                        axis_i_2_tlast , axis_o_2_tlast;
  wire[C_TUSER_WIDTH-1:0]     axis_i_2_tuser , axis_o_2_tuser;
  wire[C_NF_DATA_WIDTH/8-1:0]    axis_i_2_tkeep , axis_o_2_tkeep;
  wire                        axis_i_2_tready, axis_o_2_tready;

  wire[C_NF_DATA_WIDTH-1:0]      axis_i_3_tdata , axis_o_3_tdata;
  wire                        axis_i_3_tvalid, axis_o_3_tvalid;
  wire                        axis_i_3_tlast , axis_o_3_tlast;
  wire[C_TUSER_WIDTH-1:0]     axis_i_3_tuser , axis_o_3_tuser;
  wire[C_NF_DATA_WIDTH/8-1:0]    axis_i_3_tkeep , axis_o_3_tkeep;
  wire                        axis_i_3_tready, axis_o_3_tready;
  ...
  wire[C_DATA_WIDTH-1:0]      p_axis_i_2_tdata , p_axis_o_2_tdata;
  wire                        p_axis_i_2_tvalid, p_axis_o_2_tvalid;
  wire                        p_axis_i_2_tlast , p_axis_o_2_tlast;
  wire[C_TUSER_WIDTH-1:0]     p_axis_i_2_tuser , p_axis_o_2_tuser;
  wire[C_DATA_WIDTH/8-1:0]    p_axis_i_2_tkeep , p_axis_o_2_tkeep;
  wire                        p_axis_i_2_tready, p_axis_o_2_tready;
  
  wire[C_DATA_WIDTH-1:0]      p_axis_i_3_tdata , p_axis_o_3_tdata;
  wire                        p_axis_i_3_tvalid, p_axis_o_3_tvalid;
  wire                        p_axis_i_3_tlast , p_axis_o_3_tlast;
  wire[C_TUSER_WIDTH-1:0]     p_axis_i_3_tuser , p_axis_o_3_tuser;
  wire[C_DATA_WIDTH/8-1:0]    p_axis_i_3_tkeep , p_axis_o_3_tkeep;
  wire                        p_axis_i_3_tready, p_axis_o_3_tready;
...
//-----------------------------------------------------------------------------------------------//
	...
	axis_sim_stim_ip2 axis_sim_stim_2 (
		...
		//axi streaming data interface
		.M_AXIS_TDATA    (p_axis_i_2_tdata),
		.M_AXIS_TKEEP    (p_axis_i_2_tkeep),
		.M_AXIS_TUSER    (p_axis_i_2_tuser),
		.M_AXIS_TVALID   (p_axis_i_2_tvalid),
		.M_AXIS_TREADY   (1'b1),
		.M_AXIS_TLAST    (p_axis_i_2_tlast),
	...
	axis_sim_stim_ip3 axis_sim_stim_3 (
		.ACLK            (clk_200),
		.ARESETN         (sys_rst_n_c),
		
		//axi streaming data interface
		.M_AXIS_TDATA    (p_axis_i_3_tdata),
		.M_AXIS_TKEEP    (p_axis_i_3_tkeep),
		.M_AXIS_TUSER    (p_axis_i_3_tuser),
		.M_AXIS_TVALID   (p_axis_i_3_tvalid),
		.M_AXIS_TREADY   (1'b1),
		.M_AXIS_TLAST    (p_axis_i_3_tlast),
	...
	axis_sim_record_ip2 axis_sim_record_2 (
		.axi_aclk (clk_200),
		// Slave Stream Ports (interface to data path)
		.s_axis_tdata (p_axis_o_2_tdata),
		.s_axis_tkeep (p_axis_o_2_tkeep),
		.s_axis_tuser (p_axis_o_2_tuser),
		.s_axis_tvalid(p_axis_o_2_tvalid),
		.s_axis_tready(p_axis_o_2_tready),
		.s_axis_tlast (p_axis_o_2_tlast),
	
		.counter (counter2),
		.activity_rec(activity_rec2)
	);
	
	axis_sim_record_ip3 axis_sim_record_3 (
		.axi_aclk (clk_200),
		// Slave Stream Ports (interface to data path)
		.s_axis_tdata (p_axis_o_3_tdata),
		.s_axis_tkeep (p_axis_o_3_tkeep),
		.s_axis_tuser (p_axis_o_3_tuser),
		.s_axis_tvalid(p_axis_o_3_tvalid),
		.s_axis_tready(p_axis_o_3_tready),
		.s_axis_tlast (p_axis_o_3_tlast),
	...
	nf_mac_attachment_ip u_nf_attachment_2 (
		// 10GE block clk & rst
		.clk156                (clk_200),  
		.areset_clk156         (!sys_rst_n_c), 
		// RX MAC 64b@clk156 (no backpressure) -> rx_queue 64b@axis_clk
		.m_axis_mac_tdata      (p_axis_i_2_tdata),
		.m_axis_mac_tkeep      (p_axis_i_2_tkeep),
		.m_axis_mac_tvalid     (p_axis_i_2_tvalid),
		.m_axis_mac_tuser_err  (1'b1),       // valid frame
		.m_axis_mac_tuser      (p_axis_i_2_tuser),
		.m_axis_mac_tlast      (p_axis_i_2_tlast),
		// tx_queue 64b@axis_clk -> mac 64b@clk156
		.s_axis_mac_tdata      (p_axis_o_2_tdata),
		.s_axis_mac_tkeep      (p_axis_o_2_tkeep),
		.s_axis_mac_tvalid     (p_axis_o_2_tvalid),
		.s_axis_mac_tuser_err  (p_axis_o_2_tuser),      //underrun
		.s_axis_mac_tuser      (p_axis_o_2_tuser),
		.s_axis_mac_tlast      (p_axis_o_2_tlast),
		.s_axis_mac_tready     (p_axis_o_2_tready),
		...
		.axis_aresetn          (sys_rst_n_c),
		// input from ref pipeline 256b -> MAC
		.s_axis_pipe_tdata     (axis_o_2_tdata),
		.s_axis_pipe_tkeep     (axis_o_2_tkeep),
		.s_axis_pipe_tlast     (axis_o_2_tlast),
		.s_axis_pipe_tuser     (axis_o_2_tuser),
		.s_axis_pipe_tvalid    (axis_o_2_tvalid),
		.s_axis_pipe_tready    (axis_o_2_tready),
		// output to ref pipeline 256b -> DMA
		.m_axis_pipe_tdata     (axis_i_2_tdata),
		.m_axis_pipe_tkeep     (axis_i_2_tkeep),
		.m_axis_pipe_tlast     (axis_i_2_tlast),
		.m_axis_pipe_tuser     (axis_i_2_tuser),
		.m_axis_pipe_tvalid    (axis_i_2_tvalid),
		.m_axis_pipe_tready    (axis_i_2_tready)
	);

	nf_mac_attachment_ip u_nf_attachment_3 (
		// 10GE block clk & rst
		.clk156                (clk_200),  
		.areset_clk156         (!sys_rst_n_c), 
		// RX MAC 64b@clk156 (no backpressure) -> rx_queue 64b@axis_clk
		.m_axis_mac_tdata      (p_axis_i_3_tdata),
		.m_axis_mac_tkeep      (p_axis_i_3_tkeep),
		.m_axis_mac_tvalid     (p_axis_i_3_tvalid),
		.m_axis_mac_tuser_err  (1'b1),       // valid frame
		.m_axis_mac_tuser      (p_axis_i_3_tuser),
		.m_axis_mac_tlast      (p_axis_i_3_tlast),
		// tx_queue 64b@axis_clk -> mac 64b@clk156
		.s_axis_mac_tdata      (p_axis_o_3_tdata),
		.s_axis_mac_tkeep      (p_axis_o_3_tkeep),
		.s_axis_mac_tvalid     (p_axis_o_3_tvalid),
		.s_axis_mac_tuser_err  (p_axis_o_3_tuser),      //underrun
		.s_axis_mac_tuser      (p_axis_o_3_tuser),
		.s_axis_mac_tlast      (p_axis_o_3_tlast),
		.s_axis_mac_tready     (p_axis_o_3_tready),
		
		// TX/RX DATA channels  
		.interface_number      (8'b0000_1000),
		
		// NFPLUS pipeline clk & rst 
		.axis_aclk             (clk_200),
		.axis_aresetn          (sys_rst_n_c),
		// input from ref pipeline 256b -> MAC
		.s_axis_pipe_tdata     (axis_o_3_tdata),
		.s_axis_pipe_tkeep     (axis_o_3_tkeep),
		.s_axis_pipe_tlast     (axis_o_3_tlast),
		.s_axis_pipe_tuser     (axis_o_3_tuser),
		.s_axis_pipe_tvalid    (axis_o_3_tvalid),
		.s_axis_pipe_tready    (axis_o_3_tready),
		// output to ref pipeline 256b -> DMA
		.m_axis_pipe_tdata     (axis_i_3_tdata),
		.m_axis_pipe_tkeep     (axis_i_3_tkeep),
		.m_axis_pipe_tlast     (axis_i_3_tlast),
		.m_axis_pipe_tuser     (axis_i_3_tuser),
		.m_axis_pipe_tvalid    (axis_i_3_tvalid),
		.m_axis_pipe_tready    (axis_i_3_tready)
	);
